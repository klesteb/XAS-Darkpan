package XAS::Service::Validate::Darkpan::Packages;

our $VERSION = '0.01';

use XAS::Service::Profiles;
use XAS::Service::Profiles::Darkpan::Packages;
...
sub check {
    ...
    return $self->check_parameters($params, 'packages');
...
XAS::Service::Validate::Darkpan::Packages - A class to verify the Packages profile.

=head1 SYNOPSIS

 use XAS::Service::Validate::Darkpan::Packages;

 my $profile = XAS::Service::Validate::Darkpan::Packages->new();
