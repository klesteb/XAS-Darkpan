package XAS::Service::Validate::Darkpan::Mirrors;

our $VERSION = '0.01';

use XAS::Service::Profiles;
use XAS::Service::Profiles::Darkpan::Mirrors;
...
sub check {
    ...
    return $self->check_parameters($params, 'mirrors');
...
XAS::Service::Validate::Darkpan::Mirrors - A class to verify the Mirrors profile.

=head1 SYNOPSIS

 use XAS::Service::Validate::Darkpan::Mirrors;

 my $profile = XAS::Service::Validate::Darkpan::Mirrors->new();
