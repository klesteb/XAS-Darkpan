package XAS::Service::Validate::Darkpan::Permissions;

our $VERSION = '0.01';

use XAS::Service::Profiles;
use XAS::Service::Profiles::Darkpan::Permissions;
...
sub check {
    ...
    return $self->check_parameters($params, 'permissions');
...
XAS::Service::Validate::Darkpan::Permissions - A class to verify the Permissions profile.

=head1 SYNOPSIS

 use XAS::Service::Validate::Darkpan::Permissions;

 my $profile = XAS::Service::Validate::Darkpan::Permissions->new();
